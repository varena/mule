...
update problem set statement="Se dau două numere; să se calculeze suma acestora." WHERE `id`='1';
...
INSERT INTO `history_problem` VALUES (1,4,1,'Se dau două numere; să se calculeze suma lor.',1397927202),
(2,4,2,'Această problemă n-ar trebui să fie vizibilă în mod normal.',1397927202),
(3,4,3,'Se dau două numere; să se calculeze diferenţa lor.',1397927202),
...
(5,4,1,'Se dau două numere; să se calculeze suma acestora.',1397927202);
